...
import com.abdts.common.util.BuildTree;
import com.abdts.common.util.Tree;
import com.abdts.dao.teacher.MenuDao;
...
public class MenuServiceImpl implements MenuService {
	...
	@Cacheable
	@Override
	public Tree<MenuDO> getSysMenuTree(int id) {
	...
	@Override
	public Tree<MenuDO> getTree(int id) {
		// 根据roleId查询权限
	...
	@Override
	public List<Tree<MenuDO>> listMenuTree(int id) {
		List<Tree<MenuDO>> trees = new ArrayList<Tree<MenuDO>>();
		List<MenuDO> menuDOs = menuMapper.listMenuByUserId(id);
		for (MenuDO sysMenuDO : menuDOs) {
			Tree<MenuDO> tree = new Tree<MenuDO>();
